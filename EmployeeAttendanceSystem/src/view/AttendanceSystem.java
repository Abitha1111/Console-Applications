...
public class AttendanceSystem {
	...
	private static void markAttendance() {
		...
		for (Employee emp : employees) {
			if (emp.getId() == empId) {
				emp.markAttendance();
				found = true;
				System.out.println("Attendance marked for Employee ID: " + emp.getId());
				break;
			}
		}
	...
	private static void viewAttendance() {
		...
		for (Employee emp : employees) {
			...
			System.out.println("Attendance: " + (emp.isPresent() ? "Present" : "Absent"));
			System.out.println("Attendance Date & Time: "
